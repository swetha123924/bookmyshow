...
//         {/* Right Side - Location, Admin, User */}
//         <div className="flex flex-wrap justify-center md:justify-end items-center gap-4 w-full md:w-auto">
//           {/* Location */}
//           <div className="flex items-center gap-2 bg-[#2a2a2a] px-3 py-2 rounded-full border border-gray-600">
...
//           {/* User Button */}
//           <button className="flex items-center gap-2 bg-pink-500 hover:bg-pink-400 px-4 py-2 rounded-full text-sm font-medium">
